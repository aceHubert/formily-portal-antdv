...
exports.Page = (0, vue_demi_1.defineComponent)({
    ...
    setup: function (props, _a) {
        var slots = _a.slots;
        var prefixCls = "".concat(configs_1.stylePrefix, "-page");
        ...
        return function () {
            ...
            var renderContent = function () {
                return (0, vue_1.h)(component, { style: prefixCls }, slots);
            };
            if (top === null || top === void 0 ? void 0 : top.value) {
                ...
                return (0, vue_1.h)(vue_1.FormProvider, { props: { form: form } }, { default: function () { return renderContent(); } });
            }
        };
    },
});
