(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@lj-portal/antdv', ['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.LjPortal = global.LjPortal || {}, global.LjPortal.Antdv = {})));
    ...
    ***************************************************************************** */
    ...
    var stylePrefix = 'lj-portal-antdv';
    ...
    var Banner = defineComponent({
        ...
        setup: function (props, _a) {
            ...
            return function () {
                ...
                return h(Antd.Carousel, {
                    class: prefixCls,
                    props: __assign$1(__assign$1({}, attrs), { initialSlide: initialSlide, autoplay: autoplay, afterChange: function (current) {
                            var _a;
            ...
            return function () {
                ...
                return h('a', {
                    ...
                    on: {
                        click: function () {
                            var _a;
                            (_a = attrs.onClick) === null || _a === void 0 ? void 0 : _a.call(attrs, __assign$1({}, props));
                            emit('click', __assign$1({}, props));
                        },
                    },
    ...
    var Entry = composeExport(EntryContainer, {
        Item: EntryItem,
    });

    var HtmlContent = defineComponent({
        name: 'Html',
        props: {
            content: String,
        },
    ...
    var PageConsumerProps = {
        containerWidth: '1120px',
    };

    var PageInjectKey = hasSymbol ? Symbol() : '__PAGE_INJECT_KEY';
            ...
            useCssVars(function () {
                return props.themeVars
                    ? Object.keys(props.themeVars || {}).reduce(function (prev, curr) {
                        prev["theme-".concat(lodash_kebabcase(curr))] = props.themeVars[curr];
                        return prev;
                    }, {})
                    : {};
            });
...
//# sourceMappingURL=lj-portal.antdv.umd.development.js.map
